...
<div class="xr_ap xr_pp">
 <img class="xr_ap" src="index_htm_files/1.png" alt="" title="" style="left:-5px;top:-5px;width:789px;height:1956px;"/>
</div>
<div id="xr_xrc1" class="xr_ap xr_xri_ xr_xrc" style="width: 769px; height: 1936px; overflow:hidden;">
<div class="xr_group">
 <img class="xr_ap" src="index_htm_files/2.png" alt="" title="" style="left:0px;top:0px;width:770px;height:127px;"/>
</div>
<div class="xr_group">
 <img class="xr_ap" src="index_htm_files/3.png" alt="Xara Web Designer" title="" style="left:72px;top:49px;width:378px;height:61px;"/>
</div>
<div class="xr_group">
 <img class="xr_ap" src="index_htm_files/4.png" alt="" title="" style="left:571px;top:1695px;width:179px;height:192px;"/>
</div>
<div class="xr_group">
 <img class="xr_ap" src="index_htm_files/5.png" alt="" title="" style="left:0px;top:1904px;width:769px;height:32px;"/>
...
<div class="xr_group">
 <img class="xr_ap" src="index_htm_files/11.jpg" alt="" title="" onmousemove="xr_mp(5,0)" style="left:63px;top:947px;width:193px;height:35px;"/>
</div>
 ...
 <img class="xr_ap" src="index_htm_files/12.png" alt="" title="Click to enlarge" style="left:544px;top:149px;width:205px;height:286px;"/>
<div class="xr_group">
 <a href="http://www.xara.com/products/webdesigner/" onclick="return(xr_nn());">
  <img class="xr_ap" src="index_htm_files/13.png" alt="" title="" onmousemove="xr_mo(this,0,event)" style="left:3px;top:1908px;width:65px;height:26px;"/>
 </a>
</div>
 <a href="index_htm_files/35.jpg" class="highslide" onmouseover="hs.headingText=''" onclick="return hs.expand(this, { headingText: '', slideshowGroup: 0 } )">
  <img class="xr_ap" id="template:58object" src="index_htm_files/14.jpg" alt="" title="" onmousemove="xr_mo(this,0,event)" style="left:560px;top:165px;width:165px;height:249px;"/>
  <span class="xr_ar xr_ro xr_ro0 xr_tt3" title="Click to enlarge" style="left:560px;top:165px;width:164px;height:248px; pointer-events: none; border: 1px solid #FFFC00;"></span>
  <img class="xr_ap xr_ro xr_ro0 xr_tt3" src="index_htm_files/24.jpg" alt="" title="" style="left:560px;top:170px;width:40px;height:40px;"/>
 </a>
<div class="xr_group">
 <img class="xr_ap" src="index_htm_files/15.jpg" alt="" title="" style="left:63px;top:1100px;width:135px;height:126px;"/>
</div>
<div class="xr_group">
 <img class="xr_ap" src="index_htm_files/16.jpg" alt="" title="" style="left:28px;top:757px;width:28px;height:27px;"/>
</div>
<div class="xr_group">
 <a href="photos.htm" onclick="return(xr_nn());">
  <img class="xr_ap" src="index_htm_files/17.png" alt="" title="" onmousemove="xr_mo(this,0,event)" style="left:380px;top:1861px;width:38px;height:38px;"/>
  <img class="xr_ap xr_ro xr_ro0 xr_tt3" src="index_htm_files/25.png" alt="" title="" onmousemove="xr_mo(this,0)" style="left:388px;top:1869px;width:17px;height:18px;"/>
 </a>
</div>
<div class="xr_group">
 <a href="http://www.xara.com/link/" onclick="return(xr_nn());">
  <img class="xr_ap" src="index_htm_files/18.png" alt="Stretch button" title="" onmousemove="xr_mo(this,0,event)" style="left:339px;top:1432px;width:111px;height:24px;"/>
  <img class="xr_ap xr_ro xr_ro0 xr_tt3" src="index_htm_files/26.png" alt="Stretch button" title="" onmousemove="xr_mo(this,0)" style="left:339px;top:1432px;width:111px;height:24px;"/>
 </a>
</div>
<div class="xr_group">
 <img class="xr_ap" src="index_htm_files/36.png" alt="" title="" style="left:72px;top:165px;width:334px;height:61px;"/>
 <img class="xr_ap" src="index_htm_files/37.png" alt="" title="" style="left:381px;top:161px;width:29px;height:28px;"/>
 <img class="xr_ap" src="index_htm_files/38.png" alt="" title="" style="left:60px;top:193px;width:18px;height:18px;"/>
</div>
 ...
 <img class="xr_ap" src="index_htm_files/27.png" alt="" title="" style="left:117px;top:303px;width:589px;height:537px;"/>
 </div>
 <div class="xr_ap" onmousemove="xr_mpc(4)">
 <img class="xr_ap" src="index_htm_files/28.jpg" alt="" title="" style="left:251px;top:360px;width:216px;height:231px;"/>
 </div>
 ...
 <div class="xr_ap" onmousemove="xr_mpc(4)">
 <img class="xr_ap" src="index_htm_files/29.png" alt="" title="" style="left:261px;top:571px;width:73px;height:45px;"/>
 </div>
 <div class="xr_ap" onmousemove="xr_mpc(4)">
 <img class="xr_ap" src="index_htm_files/30.png" alt="" title="" style="left:462px;top:374px;width:34px;height:21px;"/>
 </div>
 <div class="xr_ap" onmousemove="xr_mpc(4)">
 <img class="xr_ap" src="index_htm_files/31.png" alt="" title="" style="left:396px;top:468px;width:98px;height:12px;"/>
 </div>
 ...
 <div class="xr_ap" onmousemove="xr_mpc(4)">
 <img class="xr_ap" src="index_htm_files/32.png" alt="" title="" style="left:194px;top:427px;width:69px;height:12px;"/>
 </div>
 ...
 <div class="xr_ap" onmousemove="xr_mpc(4)">
 <img class="xr_ap" src="index_htm_files/33.png" alt="" title="" style="left:336px;top:648px;width:129px;height:2px;"/>
 </div>
 </div>
 <div id="xr_xo4"></div>
 <div id="xr_xd4"></div>
...
<div class="xr_group">
 ...
 <img class="xr_ap" src="index_htm_files/34.png" alt="" title="" onmousemove="xr_mp(5,5)" style="left:52px;top:933px;width:282px;height:75px;"/>
 </div>
</div>
 </div>
 <div id="xr_xo5"></div>
...
<div id="xr_nb1" class="xr_ar">
 ...
 <a href="javascript:;" onclick="return(xr_nn());">
  <img class="xr_ap" src="index_htm_files/6.png" alt="Home" title="" onmousemove="xr_mo(this,5,event)" style="left:0px;top:0px;width:50px;height:23px;"/>
  <img class="xr_ap xr_rs" src="index_htm_files/19.png" alt="Home" title="" onmousemove="xr_mo(this,5)" style="left:5px;top:1px;width:39px;height:21px;"/>
 </a>
 </div>
 <div class="xr_ar xr_nb0">
 <a href="animation.htm" target="_self" onclick="return(xr_nn());">
  <img class="xr_ap" src="index_htm_files/7.png" alt="Photos" title="" onmousemove="xr_mo(this,5,event)" style="left:49px;top:0px;width:57px;height:23px;"/>
  <img class="xr_ap xr_ro xr_ro0 xr_tt3" src="index_htm_files/20.png" alt="Photos" title="" onmousemove="xr_mo(this,5)" style="left:54px;top:1px;width:46px;height:21px;"/>
 </a>
 </div>
 <div class="xr_ar xr_nb0">
 <a href="widgets.htm" target="_self" onclick="return(xr_nn());">
  <img class="xr_ap" src="index_htm_files/8.png" alt="Widgets" title="" onmousemove="xr_mo(this,5,event)" style="left:105px;top:0px;width:63px;height:23px;"/>
  <img class="xr_ap xr_ro xr_ro0 xr_tt3" src="index_htm_files/21.png" alt="Widgets" title="" onmousemove="xr_mo(this,5)" style="left:110px;top:1px;width:52px;height:21px;"/>
 </a>
 </div>
 <div class="xr_ar xr_nb0">
 <a href="animation.htm" target="_self" onclick="return(xr_nn());">
  <img class="xr_ap" src="index_htm_files/9.png" alt="Animation Effects" title="" onmousemove="xr_mo(this,5,event)" style="left:167px;top:0px;width:114px;height:23px;"/>
  <img class="xr_ap xr_ro xr_ro0 xr_tt3" src="index_htm_files/22.png" alt="Animation Effects" title="" onmousemove="xr_mo(this,5)" style="left:172px;top:1px;width:103px;height:21px;"/>
 </a>
 </div>
 <div class="xr_ar xr_nb0">
 <a href="advanced.htm" target="_self" onclick="return(xr_nn());">
  <img class="xr_ap" src="index_htm_files/10.png" alt="Advanced" title="" onmousemove="xr_mo(this,5,event)" style="left:280px;top:0px;width:72px;height:23px;"/>
  <img class="xr_ap xr_ro xr_ro0 xr_tt3" src="index_htm_files/23.png" alt="Advanced" title="" onmousemove="xr_mo(this,5)" style="left:284px;top:1px;width:63px;height:21px;"/>
 </a>
 </div>
</div>
</div>
